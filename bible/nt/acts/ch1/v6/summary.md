...
## Claim
This verse contributes restoration-expectation context among Jesus' followers. It matters because kingdom/restoration questions remain live after Jesus' ministry.
...
## Objection Note
The main competing reading takes the passage as the expectation is redirected within Luke-Acts rather than toward a later prophet. That sets the page's proper rank, but it does not erase the supporting constraint the passage still contributes to the larger network.
