...
`Status:` anchored. `Role:` Isaiah 42 comparison control / not prophecy evidence. `Contribution:` control; kingdom-scope calibration.

## Claim
This verse contributes Jesus' statement that his kingdom is not of this world. It matters as a secondary comparison control when testing whether public-victory and law-to-nations profiles are exhausted by Jesus' earthly mission.

## Reasoning
This page functions as a control anchor for comparison, not as proof for the thesis. Its importance grows through the linked higher-order pages, where its local contribution is reused without overloading the page itself. Identification of the Prophet (peace be upon him) from this verse is not a verse-level claim.
