...
## Objection Note
The main competing reading is genealogical background without later prophetic significance. That sets the page's proper rank, but it does not erase the supporting constraint the passage still contributes to the larger network.
