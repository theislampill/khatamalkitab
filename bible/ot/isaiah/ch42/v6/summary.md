...
## Objection Note
The strongest alternatives are Israel-as-servant or Christian application to Jesus. That sets the page's proper rank, but it does not erase the supporting constraint the passage still contributes to the larger network.
