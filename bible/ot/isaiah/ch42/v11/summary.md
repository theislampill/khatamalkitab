...
## Claim
This verse contributes Kedar and Sela geography to the servant cluster. It matters only because it intersects Genesis/Ezekiel Kedar and Paran/Arabia support lines.
...
Within the wider repository, this page chiefly strengthens [Arabian Servant And Kedar](../../../../../arguments/arabian-servant-and-kedar/summary.md), [Paran And Arabia](../../../../../arguments/paran-and-arabia/summary.md), and [Ishmaelite Line And Brethren](../../../../../arguments/ishmaelite-line-and-brethren/summary.md). It supplies the local anchor, supporting constraint, or control boundary those linked pages reuse when the case moves from passage analysis to cluster and convergence.

## Objection Note
The main competing reading takes the passage as Kedar is part of the nations' praise horizon, not candidate identity. That sets the page's proper rank, but it does not erase the supporting constraint the passage still contributes to the larger network.
